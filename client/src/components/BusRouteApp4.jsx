  ...
  return (
    <div style={containerStyle}>
      <header style={headerStyle}>
        <h1>Lumbini City Bus Route and Schedule</h1>
      </header>
      <main style={mainStyle}>
        <section style={sectionStyle}>
          ...
          <table style={tableStyle}>
            ...
            <tbody>
              <tr>
                <td style={thTdStyle}>Lumbini Gate</td>
                <td style={thTdStyle}>7:00 AM</td>
                <td style={thTdStyle}>7:05 AM</td>
              </tr>
              <tr>
                <td style={thTdStyle}>Maya Devi Temple</td>
                <td style={thTdStyle}>7:20 AM</td>
                <td style={thTdStyle}>7:25 AM</td>
              </tr>
              <tr>
                <td style={thTdStyle}>World Peace Pagoda</td>
                <td style={thTdStyle}>7:40 AM</td>
                <td style={thTdStyle}>7:45 AM</td>
              </tr>
              <tr>
                <td style={thTdStyle}>Ashokan Pillar</td>
                <td style={thTdStyle}>8:00 AM</td>
                <td style={thTdStyle}>8:05 AM</td>
              </tr>
              <tr>
                <td style={thTdStyle}>Lumbini Museum</td>
                <td style={thTdStyle}>8:20 AM</td>
                <td style={thTdStyle}>8:25 AM</td>
              </tr>
              <tr>
                <td style={thTdStyle}>Tilaurakot</td>
                <td style={thTdStyle}>8:50 AM</td>
                <td style={thTdStyle}>8:55 AM</td>
              </tr>
            </tbody>
          </table>
        </section>
        <section style={sectionStyle}>
          ...
          <div style={{ height: "400px", width: "100%", overflow: "hidden" }}>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d17619.734149478295!2d83.266285!3d27.4698294!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39968414f95a90ff%3A0x484554c623d875a0!2sLumbini!5e0!3m2!1sen!2snp!4v1687654321000!5m2!1sen!2snp"
              width="100%"
              height="400"
              style={{ border: 0 }}
              allowFullScreen=""
